...
$data = query("SELECT * FROM data_kegiatan");
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="tables.php">Data Anggota</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <a href="data-kegiatan.php"><button type="button" class="btn btn-primary mb-2">Tambah</button></a>
...
<tr>
                                            ...
                                            <td><?= $row["negara"]; ?></td>
                                            <td>
                                            <a href="edit-data-kegiatan.php?id_kegiatan=<?= $row["id_kegiatan"]; ?>"><button type="button" class="btn btn-success">Edit</button></a>
                                            <a href="hapus-kegiatan.php?id_kegiatan=<?= $row["id_kegiatan"]; ?>"><button type="button" class="btn btn-danger">Hapus</button></a>
                                            </td>
