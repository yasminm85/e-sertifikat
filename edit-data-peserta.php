...
$pgw = query("SELECT * FROM data_peserta WHERE id = $id")[0];
...
if(isset($_POST["update"]) ){
    if(edit($_POST) > 0 ){
        ...
        document.location.href = 'edit-data-peserta';
        </script>
        ";
    }
}
                ...
                <h2>Edit Data Anggota</h2>
                    ...
                    <div class="card shadow mb-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="divisi" name="divisi" value="<?= $pgw["divisi"]; ?>" required>
                            </div>
                            <div class="form-group">
                                <label for="jurusan">Jurusan</label>
                                <input type="text" class="form-control" id="jurusan" name="jurusan" value="<?= $pgw["jurusan"]; ?>" required>
                            </div>
