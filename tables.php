        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <a href="data-peserta.php"><button type="button" class="btn btn-primary mb-2">Tambah</button></a>
                      ...
                      <?php $i = 1;?>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?= $row["jurusan"]; ?></td>
                                            <td>
                                            <a href="edit-data-peserta.php?id=<?= $row["id"]; ?>"><button type="button" class="btn btn-success">Edit</button></a>
